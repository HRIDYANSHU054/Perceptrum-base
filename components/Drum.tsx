...
const Drum = memo(function Drum({
  ...
  // sounds state
  const [playSoundBoom] = useSound("/sounds/drumTom2.mp3", { volume: 1 });
  ...
  return (
    ...
    >
      <Image src="/5.png" alt="drum" width={300} height={400} />

      {/* our circle will act as the drum sheet and this will be the area where we check a hit */}
      <div
        ref={drumSheetRef}
        className="absolute top-[17%] left-[12%] -rotate-[60deg] z-10 bg-gray-700 h-[25%] w-[53%] rounded-[50%] flex justify-center items-center"
      >
